...
public class InquiryDaoImpl implements InquiryDao {
	...
	private final JdbcTemplate jdbcTemplate;  // データベースを操作するクラス 

	@Autowired  // 上記を読み込む時のアノテーション
	public InquiryDaoImpl(JdbcTemplate jdbcTemplate) {
		this.jdbcTemplate = jdbcTemplate; // DIコンテナで作成されたインスタンスが渡される
	}
	
	@Override // プリペアドステートメントになっている為、SQLインジェクションを防ぐ事ができる！
	...
	@Override // Mapで取得したデータをListに詰め直す
